...
var input = document.getElementsByClassName("calButton");
var opInput = document.getElementsByClassName("operatorButton");
var operatorInput = document.getElementById("operator");
var leftDisplayInput = document.getElementById("leftOperand");
var rightDisplayInput = document.getElementById("rightOperand");

var midListener = function (event) {
	var midInput = this.innerText;
	operatorInput.innerText = midInput;
}

var listener = function (event) {
	if (operatorInput.innerText === "") {
		var leftValue = leftDisplayInput.innerText;
		var leftInput = this.innerText;
		leftValue = leftValue + leftInput;
		document.getElementById("leftOperand").innerText = leftValue;
	} else {
...
input[0].addEventListener("click", listener);
input[1].addEventListener("click", listener);
input[2].addEventListener("click", listener);
// input[3].addEventListener("click", listener);
input[4].addEventListener("click", listener);
input[5].addEventListener("click", listener);
input[6].addEventListener("click", listener);
// input[7].addEventListener("click", listener);
input[8].addEventListener("click", listener);
input[9].addEventListener("click", listener);
input[10].addEventListener("click", listener);
// input[11].addEventListener("click", listener);
input[12].addEventListener("click", listener);
input[13].addEventListener("click", listener);
input[14].addEventListener("click", listener);
// input[15].addEventListener("click", listener);
input[16].addEventListener("click", listener);

opInput[0].addEventListener("click", midListener);
opInput[1].addEventListener("click", midListener);
opInput[2].addEventListener("click", midListener);
