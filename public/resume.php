...
<head>
    ...
    <!-- Global CSS -->
    <link rel="stylesheet" href="orbit/assets/plugins/bootstrap/css/bootstrap.min.css">   
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="orbit/assets/plugins/font-awesome/css/font-awesome.css">
    
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="orbit/assets/css/styles.css">
    ...
    <div class="wrapper">
        <div class="sidebar-wrapper">
            ...
            <div class="education-container container-block">
                ...
                <div class="item">
                    <h4 class="degree">BS in Criminal Justice</h4>
                    <h5 class="meta">Texas A&M University at Corpus Christi</h5>
                    <div class="time">2009 - 2013</div>
                </div><!--//item-->
                <div class="item">
                    <h4 class="degree">Codeup</h4>
                    <h5 class="meta">Full Stack Web Development</h5>
            ...
            <section class="skills-section section">
                ...
                <div class="skillset">        
                    ...
                    <div class="item">
                        ...
                        <div class="level-bar">
                            <div class="javascript_jquery" data-level="98%">
                            </div>                                      
                        </div><!--//level-bar-->                                 
                    </div><!--//item-->
                    ...
                    <div class="item">
                        ...
                        <div class="level-bar">
                            <div class="html_css" data-level="95%">
                            </div>                                      
                        </div><!--//level-bar-->                                 
                    </div><!--//item-->
