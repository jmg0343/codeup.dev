...
<head>
	<meta charset="UTF-8">
	<title></title>
	<link rel="stylesheet" href="/my_first_external_css.css">
</head>
<body>
	<h1>Please Sign Up</h1>
	<form method="POST" action="/debug_excercise.php">
		...
		<label for="married_separate">
			<input id="married_separate" type="radio" name="filing_status" value="married_separate">
		...
		<select name="phone type">
			...
			<option value="iphone">iPhone<optiont>
